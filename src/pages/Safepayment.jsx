  ...
  return (
    <div className="container-fluid" style={{overflow:"hidden"}}>
      <motion.div variants={mainvariants} initial="initial"  animate={scrollPosition > 100 ? "animate" : "initial"}  className="row box4" style={{display:"flex", flexDirection:"row",overflow:"hidden"}}>
        ...
        <motion.div variants={betweenVariants} initial="initial"  animate={scrollPosition > 100 ? "animate" : "initial"}  className="col-md text-center box4b" data-aos="slide-up" style={{ display: 'flex', flexDirection:"column", justifyContent: 'center', alignItems: 'center' }}>
        ...
        <motion.div variants={rightVariants} initial="initial"  animate={scrollPosition > 100 ? "animate" : "initial"} className="col-md text-center box4c" data-aos="slide-left" style={{ display: 'flex', flexDirection:"column", justifyContent: 'center', alignItems: 'center' }}>
